...
public class matrix
{
    public static void main(String [] args)
    {
        ...
        System.out.println("The time taken for multiplying 16x16 matrix with Strassen Algorithm is "+elapsed_time);
        ...
        end_time = System.nanoTime();
        elapsed_time = end_time - start_time;
        System.out.println("The time taken for multiplying 64x64 matrix with Strassen Algorithm is "+elapsed_time);
        ...
        end_time = System.nanoTime();
        elapsed_time = end_time - start_time;
        System.out.println("The time taken for multiplying 16x16 matrix with Square-Matrix Multiply is "+elapsed_time);
        ...
        end_time = System.nanoTime();
        elapsed_time = end_time - start_time;
        System.out.println("The time taken for multiplying 64x64 matrix with Square-Matrix Multiply is "+elapsed_time);
